...
// Fixed-term pledges only — charged monthly for that many months, then
// cancelled automatically (see ChargeDonationUseCase.frequency_to_plan,
// backend). The indefinite '1' (Mensual) and '12' (Anual) options were
// removed from here on request; a donation page can no longer be configured
// to offer either.
const FREQUENCY_OPTIONS = [
  { label: 'Única vez', value: 'one_time' },
  { label: 'Por 3 meses', value: '3' },
  { label: 'Por 6 meses', value: '6' },
  { label: 'Por 9 meses', value: '9' },
];
